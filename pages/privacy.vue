      ...
      <div class="row mx-2">
        ...
        <div class="col-12">
          ...
          <p>
            ...
            私たちのサービスを安心してご利用いただくために、本ポリシーにしたがって個人情報を適切に管理することをお約束いたします。
          </p>
          ...
          <h3>情報の収集方法</h3>
          <p>
            当社は、ユーザーがサービスの利用を開始する際に、氏名、生年月日、住所、電話番号、メールアドレス、銀行口座番号、クレジットカード番号などの情報をお尋ねすることがあります。
          </p>
          <p>
